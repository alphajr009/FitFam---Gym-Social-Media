  ...
  const editDescription = async () => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:5005/api/v1/workoutplans/edit/${id}`,
  ...
  const deletePost = async () => {
    ...
    try {
      const response = await axios.delete(
        `http://localhost:5005/api/v1/workoutplans/delete/${id}`
      );
  ...
  return (
    <div className="post">
      <div className="container">
        ...
        <div className="content">
          ...
          <div className="image-container">
            <div className="image-wrapper">
              <img src={`/workout/${post.id}-0.jpg`} alt="" />
              <img src={`/workout/${post.id}-0.jpg`} alt="" />
            </div>
            <img src={`/workout/${post.id}-0.jpg`} alt="" />
          </div>
        ...
        {commentOpen && <Comments workoutPlanId={post.id} />}
      </div>
      <Modal
        title="Edit Post"
